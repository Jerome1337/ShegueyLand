<header class="menu_left">
	...
	<nav>
		...
		<ul>
			...
			<li><a data-url="https://twitter.com/intent/tweet?screen_name=gradidur&text=%23ShegueyLand<?php echo $randomTweet[rand(0,count($randomTweet)-1)]?>" class="twitter" data-related="theHauteCulture,gradidur">Envois 1 Tweet @Gradur</a></li>
